...
class _CartPageState extends ConsumerState<CartPage> {
  ...
  Widget _buildCardItems(List<CartProduct> cartProducts, WidgetRef ref) {
  ...
  Widget _cartList(WidgetRef ref) {
    ...
    return _buildCardItems(cartState.cartModel!.products, ref);
  }
}
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          "Total : ${Config.currency}${cartProvider.cartModel!.grandTodal.toStringAsFixed(2)}",
