...
/// @nodoc
mixin _$OrderState {
  Map<String, dynamic>? get orderModel => throw _privateConstructorUsedError;
...
abstract class $OrderStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Map<String, dynamic>? orderModel, bool isLoading});
}
...
class _$_OrderState implements _OrderState {
  _$_OrderState(
      {final Map<String, dynamic>? orderModel, this.isLoading = false})
      : _orderModel = orderModel;

  final Map<String, dynamic>? _orderModel;
  @override
  Map<String, dynamic>? get orderModel {
    final value = _orderModel;
    if (value == null) return null;
    if (_orderModel is EqualUnmodifiableMapView) return _orderModel;
  ...
  @override
  String toString() {
    return 'OrderState(orderModel: $orderModel, isLoading: $isLoading)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_orderModel), isLoading);
...
abstract class _OrderState implements OrderState {
  factory _OrderState(
      {final Map<String, dynamic>? orderModel,
      final bool isLoading}) = _$_OrderState;
